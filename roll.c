			...
			switch(argv[i][1])
			{
				...
				print_help:
					fprintf(stderr,
						...
						"	D^!n/m Like D^m, but returns D's minimum minus 1 if n or more values roll their minimum.\n"
						"	D^n    Identical to D^1/n.\n"
						"	D_n    Identical to D_1/n.\n"
						"	D^!n   Like D^!x/n but goes bust if over half of values roll their minimum.\n"
