			...
			switch(argv[i][1])
			{
				...
				print_help:
					fprintf(stderr,
						...
						"	D~S    Rerolls once if any of the given values are rolled.\n"
						"	D\\S   Like ~ with infinite rerolls.\n"
						...
						" Where n and m represent positive whole numbers, D represents another die, and S is a set.\n"
